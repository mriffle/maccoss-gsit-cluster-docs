...
5. **Run the workflow**
   ...
   .. code-block:: bash
      ...
      /net/maccoss/vol1/maccoss_shared/nextflow/scripts/run-nextflow-carafe-maccosslab.sh
...
1. **Start a new `tmux` session and run the workflow:**
   ...
   .. code-block:: bash
      ...
      tmux new -s nextflow_run "bash -c '/net/maccoss/vol1/maccoss_shared/nextflow/scripts/run-nextflow-carafe-maccosslab.sh;exec bash'"
...
.. code-block:: bash
   ...
   /net/maccoss/vol1/maccoss_shared/nextflow/scripts/run-nextflow-carafe-maccosslab.sh -q pr
